...
## 3. There is no learned component and no calibration
...
## 4. No public dataset has been touched
...
## 5. The novelty claim is unverified
...
## 6. Personal Fitbit data proves integration and nothing more
...
## 7. Raw motion data is unavailable, which constrains the whole Stage-2 plan
...
## 8. Fairness and subgroup performance are untested
